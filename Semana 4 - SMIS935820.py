...
class EnteroaRomano:
    ...
    def convertir_a_romano(self): #Esta parte la vi en un libro, pero estaba en JAVA, tuve que cambiarlo un poco, funciono por suerte creo jajajaj
...
print("---------- Este programa convierte un numero Entero a numero Romano ---------- \n")

v1 = int(input("Ingrese un numero entero: "))  #Ingreso de dato
...
class Coche:
    ...
    def datos(self):
        print("Datos coche de pruebas:", #Primera parte
            "\n - Color:",  self.color,
            "\n - Marca:",  self.marca,
            "\n - Modelo:", self.modelo,
...
VarCarro4 = PruebaCoche("04", "Rojo Escarlata", "Lamborghini", "Aventador", "2 puertas", "3206-HLO")
